...
# NOTE the user must ensure that 0he next line refers to the correct comm port
...
testData = []
testData.append("motor") #abcde
testData.append("control") #zxcv1234
testData.append("drive" + str(1)) #a
testData.append("strafe" + str(0))
testData.append("turn" + str(.1))
